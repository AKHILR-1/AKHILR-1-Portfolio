      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div
              key={index}
              className="group relative p-8 bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm border border-blue-500/20 rounded-2xl hover:border-blue-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/20 hover:-translate-y-2"
            >
              ...
              <div className="relative z-10">
                <div className="mb-6">
                  <div className="w-full h-80 bg-gradient-to-br from-blue-900/40 to-purple-900/40 rounded-xl overflow-hidden border border-blue-500/30 group-hover:border-blue-500/50 transition-all duration-500">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.tech.map((tech, i) => (
                    <span
                      key={i}
                      className="px-3 py-1 bg-blue-500/10 border border-blue-500/30 rounded-full text-blue-300 text-xs"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="flex gap-4">
                  <a href={project.codeUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg text-white font-medium hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 hover:scale-105">
                    <Github size={18} />
                    View Code
                  </a>
                  {project.demoUrl && (
                    <a href={project.demoUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-6 py-3 border border-blue-500 rounded-lg text-blue-400 font-medium hover:bg-blue-500/10 transition-all duration-300">
