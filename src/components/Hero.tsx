      ...
      <div className="max-w-7xl w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          <div className="space-y-4 animate-fadeIn">
            ...
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-white via-cyan-200 to-blue-400 bg-clip-text text-transparent leading-tight font-orbitron">
              AKHIL R
            </h1>
            <div className="text-lg text-cyan-300 font-light tracking-wide inline-block border-l-2 border-cyan-500 pl-4 animate-slideIn whitespace-nowrap overflow-x-auto">
          ...
          <p className="text-gray-200 text-lg leading-8 text-center md:text-justify animate-fadeIn font-script tracking-wider" style={{fontStyle: 'italic'}}>
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <div className="relative">
              <button
                ...
                className="group relative px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-lg font-semibold text-white overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/50 hover:scale-105"
              >
              ...
              {showResumeMenu && (
                <div className="absolute left-full top-0 ml-3 w-64 bg-black/90 backdrop-blur-xl border border-cyan-500/30 rounded-lg shadow-2xl shadow-cyan-500/20 overflow-hidden animate-fadeIn z-50">
                  <a
                    href={specializedCV}
            ...
            <button
              ...
              className="group relative px-8 py-4 border-2 border-cyan-500 rounded-lg font-semibold text-cyan-400 overflow-hidden transition-all duration-300 hover:text-white hover:shadow-lg hover:shadow-cyan-500/50"
            >
